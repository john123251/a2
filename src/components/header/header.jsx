...
import logo1 from '../../assets/dai.png'
import logo2 from '../../assets/gxp.png'
  ...
  return (
    <header className={styles.header}>
      <div className={styles.headerLeftSide}>
        ...
        <a  href="http://wethstaking.gxpprotocol.com/" target="_blank" alt=""><img className={styles.img} src={logo} ></img></a>
        <a  href="http://daistaking.gxpprotocol.com/" target="_blank" alt=""><img className={styles.img} src={logo1}></img></a> 
        <a  href="http://gxpstaking.gxpprotocol.com/" target="_blank" alt=""><img className={styles.img1} src={logo2} ></img></a> 
